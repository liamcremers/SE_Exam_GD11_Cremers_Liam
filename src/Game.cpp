...
void Game::BindCppFunctions()
{
    ...
    lua.new_usertype<GameEngine>("GAME_ENGINE", sol::no_constructor,
                                 ...
                                 // "CalculateTextDimensions", &GameEngine::CalculateTextDimensions,
                                 ...
                                 // "FillRectWithOpacity", &GameEngine::FillRect,
                                 ...
                                 // "FillOvalWithOpacity", &GameEngine::FillOval,
                                 // "DrawArc", &GameEngine::DrawArc,
                                 // "FillArc", &GameEngine::FillArc,
                                 // "DrawString", &GameEngine::DrawString,
                                 // "DrawStringInRect", &GameEngine::DrawString,
                                 // "DrawBitmap", &GameEngine::DrawBitmap,
                                 // "DrawBitmapWithSourceRect", &GameEngine::DrawBitmap,
                                 // "DrawPolygon", &GameEngine::DrawPolygon
    );
