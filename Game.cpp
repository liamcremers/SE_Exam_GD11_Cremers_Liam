...
void Game::LuaParseScript()
{
    try
    {
        ...
        lua.open_libraries(sol::lib::base, sol::lib::package, sol::lib::string, sol::lib::table, sol::lib::math,
                           sol::lib::io, sol::lib::os, sol::lib::debug, sol::lib::bit32, sol::lib::coroutine);
...
void Game::BindCppFunctions()
{
    ...
    {
        auto font = new Font(_T("Arial"), false, false, false, 12);
        auto dimensions = GAME_ENGINE->CalculateTextDimensions(tstring(text.begin(), text.end()), font);
        return {dimensions.cx, dimensions.cy};
    });
...
auto Game::AllocateConsole() const -> void
{
